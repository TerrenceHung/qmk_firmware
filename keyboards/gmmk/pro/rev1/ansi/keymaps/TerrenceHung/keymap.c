...
tap_dance_action_t tap_dance_actions[] = {
    // Tap once for Caps Lock, tap twice for Insert
    [CaI] = ACTION_TAP_DANCE_DOUBLE(KC_CAPS, KC_INS),
};
...
//      Ct_L     Win_L    Alt_L                               SPACE                               Alt_R    FN       Ct_R     Left     Down     Right
    ...
    [0] = LAYOUT(
        ...
        TD(CaI), KC_A,    KC_S,    KC_D,    KC_F,    KC_G,    KC_H,    KC_J,    KC_K,    KC_L,    KC_SCLN, KC_QUOT,          KC_ENT,           KC_DEL,
