...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [1] = LAYOUT(
        ...
        _______, _______, _______, _______, _______, _______,  KC_INS,        KC_SCRL, _______,  KC_LBRC, KC_RBRC, LSFT(KC_LBRC), LSFT(KC_RBRC), _______,
                                   _______, _______, _______, _______,        _______, TG(3), KC_DEL, _______
    ),

    [2] = LAYOUT(
        LSFT(KC_GRV), _______,   _______,   _______,   _______,   _______,   _______,        _______, KC_MPRV,   KC_MPLY,   KC_MNXT,   _______,   _______,  QK_BOOT,
